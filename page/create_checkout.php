...
try {
    ...
    // Fetch cart items with current product stock - using correct column name
    $sql = "SELECT c.*, p.stock_quantity, p.product_id 
            FROM cart c 
    ...
    // Update product quantities - using correct column name
